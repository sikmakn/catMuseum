...
var albumPhotoRepository = __importStar(require("../db/repositories/albumPhotoRepository"));
...
router.post('/', auth_1.auth, upload.single('photo'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                photoId = _b.sent();
                return [4 /*yield*/, albumPhotoRepository.create({ photoId: photoId })];
            case 2:
...
router.get('/all', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, albumPhotoRepository.getAll()];
            case 1:
                albumPhotos = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                id = req.params.id;
                return [4 /*yield*/, albumPhotoRepository.findById(id)];
            case 1:
                photoId = (_a.sent()).photoId;
                return [4 /*yield*/, photoRepository.removeById(photoId)];
            case 2:
                _a.sent();
                return [4 /*yield*/, albumPhotoRepository.removeById(id)];
            case 3:
                deleted = _a.sent();
                res.json(deleted);
                return [3 /*break*/, 5];
